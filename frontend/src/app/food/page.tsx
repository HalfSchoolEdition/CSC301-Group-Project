  ...
  useEffect(() => {
    async function loadEstimates() {
      const locations = [
        ...
        { key: 'flexdv', name: RESTAURANTS[4].name },
        { key: 'tex', name: RESTAURANTS[5].name },
        { key: 'freshdv', name: RESTAURANTS[6].name },
        { key: 'fusion8', name: RESTAURANTS[7].name },
        { key: 'chefdv', name: RESTAURANTS[8].name },
        { key: 'thai', name: RESTAURANTS[9].name },
        { key: 'shawarma', name: RESTAURANTS[10].name },
        { key: 'crisp', name: RESTAURANTS[11].name },
        { key: 'sammiesdv', name: RESTAURANTS[12].name },
        { key: 'smoked', name: RESTAURANTS[13].name },
        { key: 'bakeddv', name: RESTAURANTS[14].name },
        { key: 'roasted', name: RESTAURANTS[15].name },
        { key: 'bodegadv', name: RESTAURANTS[16].name },
        { key: 'kettledv', name: RESTAURANTS[17].name },
        { key: 'ahsodv', name: RESTAURANTS[18].name },
        { key: 'eurobowl', name: RESTAURANTS[19].name },
        { key: 'european', name: RESTAURANTS[20].name },
        { key: 'freshdh', name: RESTAURANTS[21].name },
        { key: 'bakeddh', name: RESTAURANTS[22].name },
        { key: 'kettledh', name: RESTAURANTS[23].name },
        { key: 'quesada', name: RESTAURANTS[24].name },
        { key: 'ahsoib', name: RESTAURANTS[25].name },
        { key: 'grill', name: RESTAURANTS[26].name },
        { key: 'chefoph', name: RESTAURANTS[27].name },
        { key: 'freshoph', name: RESTAURANTS[28].name },
        { key: 'kettleoph', name: RESTAURANTS[29].name },
        { key: 'sammiesoph', name: RESTAURANTS[30].name },
        { key: 'crispoph', name: RESTAURANTS[31].name },
        { key: 'pop', name: RESTAURANTS[32].name },
        { key: 'flexoph', name: RESTAURANTS[33].name },
        { key: 'smoothie', name: RESTAURANTS[34].name },
        { key: 'bakedoph', name: RESTAURANTS[35].name },
        { key: 'bodegaoph', name: RESTAURANTS[36].name },
        { key: 'oscar', name: RESTAURANTS[37].name },
        { key: 'cstore', name: RESTAURANTS[38].name },
        { key: 'roasted', name: RESTAURANTS[39].name },
        { key: 'ahsooph', name: RESTAURANTS[40].name },
        { key: 'fair', name: RESTAURANTS[41].name },
        { key: 'circut', name: RESTAURANTS[42].name },
      ];
